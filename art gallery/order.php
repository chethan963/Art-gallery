...
<?php include('partials-front/menu.php'); ?>
    ...
    <?php 
        //CHeck whether art id is set or not
        if(isset($_GET['art_id']))
        {
            //Get the art id and details of the selected art
            $art_id = $_GET['art_id'];

            //Get the DEtails of the SElected art
            $sql = "SELECT * FROM tbl_art WHERE id=$art_id";
            //Execute the Query
            ...
            <form action="" method="POST" class="order">
                <fieldset>
                    ...
                    <div class="art-menu-desc">
                        ...
                        <input type="hidden" name="art" value="<?php echo $title; ?>">
            ...
            <?php 
                ...
                if(isset($_POST['submit']))
                {
                    ...
                    if($res2==true)
                    {
                        ...
                        $_SESSION['order'] = "<div class='success text-center'>art Ordered Successfully.</div>";
                        header('location:'.SITEURL);
                    }
                    else
                    {
                        //Failed to Save Order
                        $_SESSION['order'] = "<div class='error text-center'>Failed to Order art.</div>";
                        header('location:'.SITEURL);
                    }
