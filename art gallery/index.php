    ...
    <section class="categories">
        <div class="container">
            <h2 class="text-center">Explore Various Categories</h2>
            ...
            <?php 
                ...
                if($count>0)
                {
                    ...
                    while($row=mysqli_fetch_assoc($res))
                    {
                        ...
                        <a href="<?php echo SITEURL; ?>category-arts.php?category_id=<?php echo $id; ?>">
    ...
    <section class="art-menu">
        <div class="container">
            ...
            //Getting arts from Database that are active and featured
            //SQL Query
            $sql2 = "SELECT * FROM tbl_art WHERE active='Yes' AND featured='Yes' LIMIT 6";
            ...
            //CHeck whether art available or not
            if($count2>0)
            {
                //art Available
            ...
            {
                //art Not Available 
                echo "<div class='error'>art not available.</div>";
            }
